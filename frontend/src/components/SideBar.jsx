            ...
            <div className="p-6 space-y-6">
                ...
                {!userProfile ? (
                    ...
                    <button
                        ...
                        className="w-full bg-gray-700 hover:bg-gray-800 text-white px-6 py-3 rounded-lg text-sm font-semibold transition-colors duration-200 shadow-sm flex items-center justify-center gap-2"
                    >
