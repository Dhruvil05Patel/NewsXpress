...
* **Given** the user enters a username that is taken or violates username rules,(Min 5 characters, Max 30 characters,Only {letters,underscore(_),numbers,period(.)},No spaces,Does not start with period,No consicutive periods).
    
    * **When** they attempt to register.
    
...
    
    * **Then** the system provides immediate visual confirmation (e.g., looks good) that the username is available and valid.
...
    
    * **Then** the article content is stored in a database ready for processing.
...
### Back of the card: Acceptance Criteria
* **Primary Actor:** System
* **Given** the system has fetched a new article.
    
...
### Back of the card: Acceptance Criteria
* **Primary Actor:** System
* **Given** the system receives a full article text from the ingestion queue.
    
    * **When** the AI generates the summary.
    
    * **Then** a valid, concise summary ($\le 60$ words) is produced and stored.
...
### US10: View Aggregated News Articles
...
* **Given** the system has processed articles with summaries.
    
...
    
    * **Then** the stored AI-generated summary and the original reference link are displayed.
* **Given** the user clicks the "Read Full Article" link.
    
    * **When** the link is clicked.
    
    * **Then** the system navigates to the external source.
* **Given** the stored summary status is "Failed" or "Placeholder".
    
    * **When** the summary page loads.
    
    * **Then** the system displays an error message or the placeholder text.

### US12: Read the Whole Article
### Front of the Card
...
* **Given** the source link is broken.
    
    * **When** the user clicks the link.
    
    * **Then** the system shows a broken link error.

### US13: Text-to-Speech for Summaries
### Front of the Card
...
### US14: Bookmark/Save Article for Later
### Front of the Card
...
### US16: Receive Notifications of Personalized News
### Front of the card
...
    
    * **When** the system finds breaking news in the user’s 
    interest.
    
...
### US18: Submit an Inquiry via Contact Form
### Front of the Card
> **As a User / Surfer I want to easily fill out and submit a "Contact Us" form to send an inquiry.**

### Back of the Card
* **Primary Actor:** User / Surfer
* **Given** the user has entered valid data in all required fields.
    
...
### US19: Delete Account Permanently
### Front of the Card
...
### Back of the Card: Acceptance Criteria
* **Primary Actor:** User/Surfer
* **Given** the system has integrated a live streaming source.
